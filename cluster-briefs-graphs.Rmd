...
ggplot(nonduplicated %>% filter(cluster == "Agriculture, Food, and Natural Resources", !is.na(predominant_education_level)), aes(pathway, projection, fill = predominant_education_level)) + geom_col(position = "fill", stat = "identity")
```
