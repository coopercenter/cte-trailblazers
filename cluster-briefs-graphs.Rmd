...
ggplot(nonduplicated %>% filter(cluster == "Agriculture, Food, and Natural Resources"), aes(pathway, projection, fill = predominant_education_level)) + geom_col(position = "fill", stat = "identity")
```
