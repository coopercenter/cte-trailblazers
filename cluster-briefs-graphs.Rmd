...
```{r importing spreadsheet & packages, makign edits for ease of graphing warning = FALSE, message = FALSE}
library(readxl)
library(tidyverse)
library(reshape2)
library(scales)
...
for (x in cluster_list){
  ...
  edu_graph <- nonduplicated %>% filter(cluster == x, 
     ...
     ggplot(aes(pathway_for_labels, projection, fill = predominant_education_level)) + 
...
my_colors3  <- c("#0072B2","#56B4E9", "#E69F00", "#009E73",
